...
public extension AppleColor {
    ...
    var rgba: (r: CGFloat, g: CGFloat, b: CGFloat, a: CGFloat) {
        let convertedColor = rgbColorSpace
        var r: CGFloat = 0
        var g: CGFloat = 0
        var b: CGFloat = 0
        var a: CGFloat = 0
    ...
    var ryba: (r: CGFloat, y: CGFloat, b: CGFloat, a: CGFloat) {
        let components = rgba
        var r = components.r
        var g = components.g
        var b = components.b
    ...
    var cmyka: (c: CGFloat, m: CGFloat, y: CGFloat, k: CGFloat, a: CGFloat) {
        var c: CGFloat = 0
        var y: CGFloat = 0
        var m: CGFloat = 0
        var k: CGFloat = 0
    ...
    var rgbaColor: AppleColor {
        let alpha = cgColor.alpha

        let opaqueColor = cgColor.copy(alpha: 1.0)
