...
public extension AppleColor {
    ...
    func blendRGB(color: AppleColor) -> AppleColor {
    ...
    func blendRGB(color: AppleColor, blendValue unsafeAlpha: CGFloat) -> AppleColor {
    ...
    func blendRGBBetween(color: AppleColor, steps: Int) -> [AppleColor] {
        if steps == 0 {
            return []
        }
        if steps == 1 {
    ...
    func blendRGBMax(color: AppleColor) -> AppleColor {
        let alphaColor = rgba
        let betaColor = color.rgba
    ...
    func blendRYB(color: AppleColor, blendValue unsafeAlpha: CGFloat) -> AppleColor {
        let alpha = min(1.0, max(0.0, unsafeAlpha))
        let beta = 1.0 - alpha
        let alphaColor = ryba
    ...
    func blendRYB(color: AppleColor) -> AppleColor {
        let colors = [self, color]
    ...
    func blendCMYK(color: AppleColor) -> AppleColor {
        let colors = [self, color]
